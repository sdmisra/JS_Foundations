...
describe('Ogre', () => {
  ...
  it('The Ogres default home is the swamp.', function() {
    const ogre = new Ogre({name: 'Brak'});
    assert.equal(ogre.home, 'Swamp');
  });

  it('The Ogre can have a different home.', function() {
    const ogre = new Ogre({name: 'Brak', abode: 'The Ritz'});
    assert.equal(ogre.home, 'The Ritz');
  });

  it('Ogres can encounter humans in their homes.', function() {
    const ogre = new Ogre({name: 'Brak'});
  ...
  it('Humans are capable of spotting the lurking ogres, eventually.', function() {
    const ogre = new Ogre({name: 'Brak'});
    const human = new Human('Jane');
  ...
  it('The human loses sight of and finds the ogre every so often.', function() {
    const ogre = new Ogre({name: 'Brak'});
    const human = new Human('Jane');
  ...
  it('The ogre can swing at the human.', function() {
    const ogre = new Ogre({name: 'Brak'});
    const human = new Human('Jane');
